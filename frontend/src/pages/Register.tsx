...
import { Sparkles, User, Mail, Lock, ArrowRight, Heart } from 'lucide-react'
...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.detail || '注册失败，请检查信息')
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-sky-50 via-blue-50 to-indigo-100">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-700 mt-4">很高兴认识你！</h1>
          <p className="text-gray-400 text-sm mt-1">创建账号，开始你的面试准备之旅</p>
        </div>
